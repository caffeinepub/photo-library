...
import type { ExternalBlob as _ExternalBlob, ListAlbumPhotosResponse as _ListAlbumPhotosResponse, ListPhotosResponse as _ListPhotosResponse, Photo as _Photo, SharedAlbum as _SharedAlbum, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPhotosToAlbum(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotosToAlbum(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlbum(arg0: string): Promise<SharedAlbum> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlbum(arg0);
                return from_candid_SharedAlbum_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAlbumPhoto(arg0: string, arg1: string): Promise<Photo> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlbumPhoto(arg0, arg1);
    ...
    async getAlbumPhotosPaginated(arg0: string, arg1: bigint | null, arg2: bigint | null): Promise<ListAlbumPhotosResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlbumPhotosPaginated(arg0, to_candid_opt_n16(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n16(this._uploadFile, this._downloadFile, arg2));
                return from_candid_ListAlbumPhotosResponse_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAllPhotosPaginated(arg0: bigint | null, arg1: bigint | null): Promise<ListPhotosResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPhotosPaginated(to_candid_opt_n16(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n16(this._uploadFile, this._downloadFile, arg1));
                return from_candid_ListPhotosResponse_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getUserPhoto(arg0: Principal, arg1: string): Promise<Photo> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPhoto(arg0, arg1);
                return from_candid_Photo_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPhotosPaginated(arg0: Principal, arg1: bigint | null, arg2: bigint | null): Promise<ListPhotosResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPhotosPaginated(arg0, to_candid_opt_n16(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n16(this._uploadFile, this._downloadFile, arg2));
                return from_candid_ListPhotosResponse_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAlbums(): Promise<Array<SharedAlbum>> {
        if (this.processError) {
            try {
    ...
    async removePhotoFromAlbum(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async renameAlbum(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.renameAlbum(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAlbumCoverPhoto(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAlbumCoverPhoto(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePhotoCaption(arg0: string, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePhotoCaption(arg0, to_candid_opt_n25(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMultiplePhotos(arg0: Array<Photo>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMultiplePhotos(await to_candid_vec_n26(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ListAlbumPhotosResponse_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ListAlbumPhotosResponse): Promise<ListAlbumPhotosResponse> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
async function from_candid_ListPhotosResponse_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ListPhotosResponse): Promise<ListPhotosResponse> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
...
function from_candid_SharedAlbum_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SharedAlbum): SharedAlbum {
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverPhotoId: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.coverPhotoId))
    };
}
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        photos: await from_candid_vec_n19(_uploadFile, _downloadFile, value.photos),
...
function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SharedAlbum>): Array<SharedAlbum> {
    return value.map((x)=>from_candid_SharedAlbum_n10(_uploadFile, _downloadFile, x));
}
...
async function to_candid_Photo_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Photo): Promise<_Photo> {
...
async function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        blob: await to_candid_ExternalBlob_n29(_uploadFile, _downloadFile, value.blob),
        name: value.name,
        createdAt: value.createdAt,
...
async function to_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Photo>): Promise<Array<_Photo>> {
    return await Promise.all(value.map(async (x)=>await to_candid_Photo_n27(_uploadFile, _downloadFile, x)));
}
